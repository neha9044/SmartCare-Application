...
import 'pdf_summarization_screen.dart';
import 'package:smartcare_app/screens/patient/valut_screen.dart'; // <-- NEW IMPORT FOR PDF SUMMARIZER
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              Icon(Icons.summarize_rounded, color: darkBlue, size: 30),
              ...
              Icon(Icons.arrow_forward_ios_rounded, color: darkBlue, size: 16),
            ],
          ),
        ),
      ),
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              const Icon(Icons.lock_outline, color: Colors.green, size: 30),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(
                      'Hide and encrypt your private medical files.',
                      style: TextStyle(fontSize: 12, color: Colors.grey[700]),
                      maxLines: 2,
                      overflow: TextOverflow.ellipsis,
                    ),
